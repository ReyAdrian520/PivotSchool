...
func getProductsHandler(w http.ResponseWriter, r *http.Request) {
	...
	log.Println("Products Located! Loading products to client...")
...
func getProductHandler(w http.ResponseWriter, r *http.Request) {
	log.Println("Uploading request from client...")
	...
	log.Println("Request confirmed! Searching for product...")
	if itemID < 0 || itemID > int64(len(info)) {
		...
		for _, product := range info {
			if int64(product.ID) == itemID {
				log.Println("Product Located! Returning product to client...")
